	...
	{foreach from=$products item="product"}
          ...
          <div class="thumbnail-container">
            {block name='product_thumbnail'}
              <a href="{$product.url|escape:'html':'UTF-8'}#main" class="thumbnail product-thumbnail">
            ...
            <div class="mm-product-description">
              ...
              {/if}
                <div>
                    <p>
                        Valable à partir du {$product->specificPrice.to|date_format:"%e/%m/%Y"}
                    </p>
                    <p>
                        jusqu'au {$product.specific_prices_to}
                    </p>
                </div>
            </div>
